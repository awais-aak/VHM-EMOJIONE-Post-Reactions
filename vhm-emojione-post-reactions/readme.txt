...
Tags: emojis, emojione, reactions, feelbox, smileys
...
Major features in VHM Show Comments includes:
* Add as many reactions as you would like
* Prevent users to react more than once.
== Installation ==
1. Upload the VHM EMOJIONE Post Reaction plugin to your plugins folder
1. Activate the plugin
1. Go to `Settings > VHM EMOJIONE Post Reaction` for further information
== Screenshots ==
