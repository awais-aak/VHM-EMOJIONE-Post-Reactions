jQuery(document).ready(function() {	
	...
	var wrapper = jQuery('#vhm-emojione-reaction-list');
	var add_button = jQuery('#add_vhm_emojione_reaction');
	
	jQuery(add_button).bind('click', (function(e){
		var i = (jQuery('#vhm-emojione-reaction-list tr').length > 0) ? parseInt(jQuery("input[name='reaction_id']").last().val()) + 1 : 0 ;
